...
| 3 | Маягт: камер, GPS, `[📍]` хаяг олох, Leaflet | ✅ дууссан |
| 4 | Давхардал + чанарын шалгалт | ✅ дууссан |
| 5 | Админ дэлгэц | ✅ дууссан |
| 6 | Экспорт (`.sql`) + Hotel SaaS талын миграци | ⏳ дараагийнх |
...
Эхний ADMIN үүссэний дараа бусад алба хаагчийг **`/admin/surveyors`**
дэлгэцээс нэмнэ — систем түр нууц үг үүсгэж нэг удаа харуулна.
